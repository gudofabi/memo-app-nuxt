<template>
  <transition name="fade" @enter="enter" @leave="leave">
    <div
      v-if="data_show"
      class="fixed bottom-4 right-4 md:bottom-8 md:right-8 flex items-center p-4 mb-4 w-full max-w-md text-gray-500 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 z-50"
      :class="{
